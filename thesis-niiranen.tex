...
Two categories exist in the typing of programming languages. Most mainstream languages fall in to the category of~\textit{typed} languages, where program values are bound with information about their types~\parencite{cardelli1996type}.~\textit{Untyped} languages, such as assembly languages, omit such information and contain at most one general type (e.g. bit patterns in assembly). This means that operations can be done on any values and their combinations, decreasing the safety of the language. 
