...
\begin{figure}[h]\centering
    ...
    arrow/.style={->,ultra thick},
        ...
        \draw[arrow] (208:2.7)  -- (206:1.8) node[left]{scores};
  ...
  ]{TODO: Example of call graph~\parencite{fenton1998software}}
...
\begin{itemize}
    ...
    \item~\textit{Content coupling relation} $R_5$ when $x$ refers and changes the contents (e.g. values, state) of $y$.
\end{itemize}
%{{{
\begin{comment}
