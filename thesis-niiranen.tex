...
As the research on software metrics traditionally centers on imperative languages,~\textit{Flowgraphs} are an intuitive way of mapping the ``flow'' of program statements. Moreover, flowgraphs are directed graphs that indicate program statements as nodes, and flow of control as arcs in the graph.
%{{{
\begin{comment}
