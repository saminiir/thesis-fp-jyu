...
\noindent This approach enforces the strict semantics of evaluation, because function parameters are always eagerly evaluated even when they are not used~\parencite{pierce2002types}. Most programming languages utilize this evaluation strategy.
