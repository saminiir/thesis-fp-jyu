...
(2) pruning (``snowballing'') these citation lists for studies relevant to the topic. Sources were searched with the keywords ``software metrics'', ``functional programming'' and the previous joined together. The process of gathering the references had no fixed timespan, but rather was active almost the life time of the thesis writing process from early 2014 to late 2014.
