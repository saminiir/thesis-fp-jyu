...
The principles of~\textit{Low coupling and high cohesion} were first proposed by~\citet{stevens1974structured}, who argue that better program code can be achieved by encapsulating similar functionality with similar dependencies to one entity (high cohesion), and in turn, separating functionality that have few dependencies between each other (low coupling) to separate entities~\parencite{beck2011congruence}. 
