...
Software quality and metrics is a branch of software engineering, where the quality of code is analyzed and quantified. The purpose of this observation is to e.g. identify problematic modules in the code and predict future maintenance effort~\parencite{fenton1999software}. Traditionally, however, software metrics have mostly dealt with imperative and object-oriented programming paradigms, and as such, the metrics are tailored for them~\parencite{harrison1996evaluation,basili1996validation,li1993object,chidamber1994metrics}. As the use of functional (reactive) programming increases, also the analysis of such programs is increasingly required. This, in turn, has called out researchers to update and add software metrics that also fit to the functional paradigm concepts~\parencite{ryder2005software,harrison1995estimating}.
...
\begin{itemize}
    \item Construct software metrics that can be applied on the internal attributes of code written with FRP, and develop a tool for quantifying the metrics of given FRP source code
